function renderComplexityTable(tableDivId, buildAction) {
  function ajaxRequestFunc(url, config, params) {
    var self = this;

    return new Promise(function (resolve, reject) {
      buildAction.getComplexityTableModel(params.page, params.size, function (model) {
  ...
  var table = new Tabulator(tableDivId,
    {
      ...
      columns:[ //Define Table Columns
        ...
        { title:"Start", field:"start", widthGrow:1},
        { title:"End", field:"end", widthGrow:1},
        { title:"Value", field:"value", widthGrow:1},
      ]
    });
}
