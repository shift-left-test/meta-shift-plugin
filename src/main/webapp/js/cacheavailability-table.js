function renderCacheAvailabilityTable(tableDivId, buildAction) {
  function ajaxRequestFunc(url, config, params) {
    var self = this;

    return new Promise(function (resolve, reject) {
      buildAction.getCacheTableModel(params.page, params.size, function (model) {
  ...
  var table = new Tabulator(tableDivId,
    {
      ...
      columns:[ //Define Table Columns
        ...
        { title:"Available", field:"available", widthGrow:1},
      ]
    });
}
