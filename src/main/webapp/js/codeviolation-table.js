function renderCodeViolationTable(tableDivId, buildAction) {
  function ajaxRequestFunc(url, config, params) {
    var self = this;

    return new Promise(function (resolve, reject) {
      buildAction.getCodeViolationTableModel(params.page, params.size, function (model) {
  ...
  var table = new Tabulator(tableDivId,
    {
      ...
      columns:[ //Define Table Columns
        ...
        { title:"Column", field:"column", widthGrow:1},
        ...
        { title:"Tool", field: "tool", widthGrow:1},
      ]
    });
}
