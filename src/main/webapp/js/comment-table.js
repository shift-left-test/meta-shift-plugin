function renderCommentTable(tableDivId, buildAction) {
  function ajaxRequestFunc(url, config, params) {
    var self = this;

    return new Promise(function (resolve, reject) {
      buildAction.getCommentTableModel(params.page, params.size, function (model) {
  ...
  var table = new Tabulator(tableDivId,
    {
      ...
      columns:[ //Define Table Columns
        ...
        { title:"CommentLines", field:"commentLines", widthGrow:1},
      ]
    });
}
