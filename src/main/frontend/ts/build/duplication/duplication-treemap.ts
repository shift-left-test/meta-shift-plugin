...
@customElement('duplication-treemap')
/**
 * build recipe treemap.
 */
export class DuplicationTreemap extends RecipeTreemap {
  /**
   * constructor.
   */
  constructor() {
      ...
      if (tooltipInfo !== undefined) {
        return `<div class="tooltip-title">
          ...
          <div class="tooltip-body">
            ...
            <div>
              <div class="tooltip-qualified-key">Duplicate:</div>
              <div class="tooltip-qualified-value">
                ${tooltipInfo.first.toLocaleString()}
              </div>
            </div>
            <div>
              <div class="tooltip-qualified-key">Unique:</div>
              <div class="tooltip-qualified-value">
