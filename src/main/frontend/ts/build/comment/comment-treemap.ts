...
@customElement('comment-treemap')
/**
 * build recipe treemap.
 */
export class CommentTreemap extends RecipeTreemap {
  /**
   * constructor.
   */
  constructor() {
      ...
      if (tooltipInfo !== undefined) {
        return `<div class="tooltip-title">
          ...
          <div class="tooltip-body">
            <div>
              <div class="tooltip-qualified-key">Comments:</div>
              <div class="tooltip-qualified-value">
                ${tooltipInfo.first.toLocaleString()}
              </div>
            </div>
            <div>
              <div class="tooltip-qualified-key">Code:</div>
              <div class="tooltip-qualified-value">
